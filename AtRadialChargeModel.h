...
private:
   ...
   //Double_t fDriftVel{0.00714};           //< Drift velocity of He ion in gas [cm/us]
   //Double_t fMobilityElec{1.02e-5}; //< Mobility of He ion (calculated from drift velocity) [cm2/V/us]   
